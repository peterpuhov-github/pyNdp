...
{
      public static String python_test() {
        try(PythonInterpreter pyInterp = new PythonInterpreter()) {
            String cmd = "import sys\nsys.path.append('/data')\nimport dike.client.spark_driver\nprint('Hello Python World!')\n";
            cmd += "command = dike.client.spark_driver.create_spark_worker_command()\n";
            pyInterp.exec(cmd);
            String command = pyInterp.get("command", String.class);
            return command;
        }
      }

      public static String python_test1() {
    ...
    public static Thread StartServer(String cmdStr)
    {
